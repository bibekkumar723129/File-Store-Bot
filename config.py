...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002691313384"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002691313384"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002691313384"))
FORCE_SUB_CHANNEL4 = int(os.environ.get("FORCE_SUB_CHANNEL4", "-1002691313384"))
...
USER_REPLY_TEXT = os.environ.get("USER_REPLY_TEXT", "Hi, I am made by @DadyIsCalling")
...
APP_ID = int(os.environ.get("APP_ID", "22582906"))
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002509118987"))
# Enter your personal Telegram user ID (you can get it by sending '/id' to https://t.me/MissRose_bot).
OWNER_ID = int(os.environ.get("OWNER_ID", "7861690278"))
...
OWNER_TAG = os.environ.get("OWNER_TAG", "DadyIsCalling")
...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "25e3fd19a4ac7dee2affd0c1890129b60c6be2d7")
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/UniformHelp/1499/2096")
...
UPI_ID = os.environ.get("UPI_ID", "bibekkumar@fam")
# Enter the direct image URL of your UPI QR code (used for payment).
UPI_IMAGE_URL = os.environ.get("UPI_IMAGE_URL", "https://i.ibb.co/hFjZ6CWD/photo-2025-08-10-02-24-51-7536777335068950548.jpg")
...
# Duration: 3 Months
PRICE3 = os.environ.get("PRICE3", "₹120")

# Duration: 6 Months
PRICE4 = os.environ.get("PRICE4", "₹250")

# Duration: 1 Year
PRICE5 = os.environ.get("PRICE5", "₹500")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7861690278").split()):
        ADMINS.append(int(x))
except ValueError:
